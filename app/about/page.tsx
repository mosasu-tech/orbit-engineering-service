...
export default async function AboutPage() {
  ...
  const seo = Object.fromEntries(rows.filter(r => r.Section === 'SEO').map(r => [r.Field, r.Value]))
  const about = Object.fromEntries(rows.filter(r => r.Section === 'About').map(r => [r.Field, r.Value]))
