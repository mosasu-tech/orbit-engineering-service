...
;
const metadata = {
    title: 'Orbit Engineering Services - Engineering Excellence Through Innovation',
    description: 'Leading provider in BIM services, CAD drafting, and construction solutions for modern infrastructure.',
    openGraph: {
        title: 'Orbit Engineering Services',
        description: 'BIM, CAD drafting and infrastructure solutions',
        images: [
            {
                url: '/og-image.jpg',
                width: 1200,
