...
"[project]/orbit-engineering-service/node_modules/next/dist/compiled/stream-http/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function() {
    var e = {
        ...
        726: function(e, t, r) {
            var n = r(781);
            if (__TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.READABLE_STREAM === "disable" && n) {
        ...
        450: function(e, t, r) {
            ...
            var l = e.exports = function(e) {
                ...
                t._body = [];
                t._headers = {};
                if (e.auth) t.setHeader("Authorization", "Basic " + __TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e.auth).toString("base64"));
                ...
                if (r === "fetch") {
                        ...
                        var s = new WritableStream({
                            write: function(e) {
                                return new Promise(function(t, r) {
                                    if (o._destroyed) {
                                        r();
                                    } else if (o.push(__TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e))) {
                                        t();
                                    } else {
                                        o._resumeFetch = t;
                                    }
                    ...
                    function read() {
                        f.read().then(function(e) {
                            ...
                            o.push(__TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e.value));
                            read();
                        }).catch(function(e) {
                            /*TURBOPACK member replacement*/ __turbopack_context__.g.clearTimeout(i);
                            if (!o._destroyed) o.emit("error", e);
            ...
            s.prototype._onXHRProgress = function() {
                ...
                switch(e._mode){
                    case "text":
                        ...
                        if (r.length > e._pos) {
                            ...
                            if (e._charset === "x-user-defined") {
                                var i = __TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(n.length);
                    ...
                    case "arraybuffer":
                        ...
                        r = t.response;
                        e.push(__TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(new Uint8Array(r)));
                        break;
                    ...
                    case "ms-stream":
                        ...
                        s.onprogress = function() {
                            if (s.result.byteLength > e._pos) {
                                e.push(__TURBOPACK__imported__module__$5b$project$5d2f$orbit$2d$engineering$2d$service$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(new Uint8Array(s.result.slice(e._pos))));
        ...
        310: function(e) {
            "use strict";
            e.exports = __turbopack_context__.r("[project]/orbit-engineering-service/node_modules/next/dist/compiled/native-url/index.js [app-client] (ecmascript)");
        },
        837: function(e) {
            "use strict";
    ...
    if (typeof __nccwpck_require__ !== "undefined") __nccwpck_require__.ab = ("TURBOPACK compile-time value", "/ROOT/orbit-engineering-service/node_modules/next/dist/compiled/stream-http") + "/";
...
//# sourceMappingURL=14ef0_next_dist_compiled_stream-http_index_679413f2.js.map